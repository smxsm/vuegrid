<template>
  <div class="hello">
    ...
    <div class="info">
      ...
      datatable, which was easy to use, stable and had all the features the projects needed.
      <br/>
      So I figured, if I can find a decent datatable component for Vue.js, it would be a good sign for the Vue.js framework and community and also a good way to dive
      into the framework very fast :)
    </div>
    ...
    <div>
      ...
      <ul>
        <li>very lean</li>
        <li>client and server data by config</li>
        <li>remote data mapping for external APIs via "ResponseAdapter"</li>
        <li>example Laravel Backend included</li>
      </ul>
    ...
    <div>
      ...
      <ul>
        ...
        <li>feature-rich</li>
        <li>aggregations</li>
        <li>grouping by dragging of header cells</li>
        <li>other cool components</li>
    ...
    <h3>4) <a href="https://vuetifyjs.com/components/datatables" target="_blank">Vuetify</a></h3>
    <div>
      ...
      <ul>
        ...
        <li>good documentation</li>
        <li>easy configuration, many config options</li>
        <li>established, many committers and forks</li>
      </ul>

      <h4>Drawbacks</h4>
      <ul>
        <li>no remote / async data support</li>
        <li>very focussed on Material Design</li>
      </ul>
    </div>
    ...
    <p>All the datatable components I have tested seem to "do their job". Most of them (except Vuetify and JQuery Datatables probably) share the drawback though
    ...
    <p>That being said, none of the solutions is "perfect", but I think every of these components can be used for "real life" projects,
      it really depends which features you need
      and which one "feels" better to you. My current personal favourites would be <strong>"Vuetiful"</strong> and <strong>"Vuetify"</strong>,
...
<script>
  ...
  export default {
    ...
    data () {
      return {
        msg: 'Welcome to the Vue.js DataTable Comparison'
      }
    },
    mounted () {
    },
